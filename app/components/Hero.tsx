        ...
        */}
        <div className="mt-10 md:mt-12 flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6">
            ...
            <a 
              href="#contact" 
              onClick={handleScroll} 
              className="w-fit min-w-[200px] border border-gray-700 hover:border-blue-500 text-white px-10 py-3 rounded-xl font-medium transition-all text-sm md:text-base text-center"
            >
              {t.btnContact}
            </a>
        </div>
